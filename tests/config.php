...
return array(
    ...
    'install_dir' => __DIR__ . '/../vendor/ezsystems/ezpublish-kernel',
    // Path to the containerBuilder.php file used by service container
    'container_builder_path' => __DIR__ . '/../vendor/ezsystems/ezpublish-kernel/eZ/Publish/Core/settings/containerBuilder.php',
    // The cache directory
