...
/**
 * File contains: EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\User\UserHandlerTest class.
 *
 * @copyright Copyright (C) eZ Systems AS. All rights reserved.
 * @license For full copyright and license information view LICENSE file distributed with this source code.
 */
namespace EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\User;

use eZ\Publish\API\Repository\Values\User\Role as APIRole;
use EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\TestCase;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\User;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\User\Role\LimitationConverter;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\User\Role\LimitationHandler\ObjectStateHandler as ObjectStateLimitationHandler;
...
class UserHandlerTest extends TestCase
{
    ...
    {
        $this->insertDatabaseFixture(__DIR__ . '/../../../../vendor/ezsystems/ezpublish-kernel/eZ/Publish/Core/Repository/Tests/Service/Integration/Legacy/_fixtures/clean_ezdemo_47_dump.php');
        $handler = $this->getUserHandler();
