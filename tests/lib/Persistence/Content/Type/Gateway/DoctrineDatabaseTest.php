...
/**
 * File contains: EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabaseTest class.
 *
 * @copyright Copyright (C) eZ Systems AS. All rights reserved.
 * @license For full copyright and license information view LICENSE file distributed with this source code.
 */
namespace EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway;

use EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\Content\LanguageAwareTestCase;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase;
...
/**
 * Test case for EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase.
 */
class DoctrineDatabaseTest extends LanguageAwareTestCase
{
     ...
     *
     * @var \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase
     */
    protected $gateway;
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::__construct
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::insertGroup
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::updateGroup
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::countTypesInGroup
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::countGroupsForType
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteGroup
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadGroupData
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::createGroupLoadQuery
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadGroupDataByIdentifier
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::createGroupLoadQuery
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadAllGroupsData
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::createGroupLoadQuery
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadTypesDataForGroup
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadTypeData
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::getLoadTypeQuery
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::selectColumns
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadTypeDataByIdentifier
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::getLoadTypeQuery
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::selectColumns
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadTypeDataByRemoteId
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::getLoadTypeQuery
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::selectColumns
     */
     ...
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::insertType
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::setCommonTypeColumns
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::insertTypeNameData
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::insertFieldDefinition
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::setCommonFieldColumns
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteFieldDefinition
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::updateFieldDefinition
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::setCommonFieldColumns
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::insertGroupAssignment
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::loadGroupData
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteGroupAssignment
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::updateType
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::setCommonTypeColumns
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteTypeNameData
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::insertTypeNameData
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::updateType
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::countInstancesOfType
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteFieldDefinitionsForType
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteGroupAssignmentsForType
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::deleteType
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase::publishTypeAndFields
     */
     ...
     *
     * @return \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Type\Gateway\DoctrineDatabase
     */
