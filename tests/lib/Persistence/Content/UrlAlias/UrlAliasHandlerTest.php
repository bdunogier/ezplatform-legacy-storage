...
/**
 * File contains: EzSystems\Tests\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAliasHandlerTest class.
 *
...
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Location\Gateway as LocationGateway;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Mapper;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Gateway\DoctrineDatabase;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\SlugConverter;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Location\Gateway\DoctrineDatabase as DoctrineDatabaseLocation;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Language\Handler as LanguageHandler;
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\Language\Gateway\DoctrineDatabase as LanguageGateway;
...
class UrlAliasHandlerTest extends TestCase
{
     ...
     * Simple lookup case.
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::lookup
     * @group location
     * @group virtual
     * @group resource
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::listURLAliasesForLocation
     */
     ...
     * @todo document
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::publishUrlAliasForLocation
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::createCustomUrlAlias
     * @group create
     * @group custom
     */
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::createGlobalUrlAlias
     * @group create
     * @group global
     */
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::createUrlAlias
     * @group create
     * @group custom
     */
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::listGlobalURLAliases
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::locationDeleted
     */
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::locationMoved
     */
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::locationCopied
     */
     ...
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::loadUrlAlias
     * @dataProvider providerForTestLookupLocationMultipleLanguages
     */
     ...
     * @group swap
     *
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::locationSwapped
     */
     ...
     * @param array $methods
     *
     * @return \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    /**
     * @return \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler
     */
    ...
    /**
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\UrlAlias\Handler::archiveUrlAliasesForDeletedTranslations()
     *
