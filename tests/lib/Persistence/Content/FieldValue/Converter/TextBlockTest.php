...
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\TextBlockConverter;
...
{
    /**
     * @var \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\TextBlockConverter
     */
    protected $converter;
...
EOT;
     ...
     * @group fieldType
     * @group textBlock
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\TextBlockConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group textBlock
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\TextBlockConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group textBlock
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\TextBlockConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group textBlock
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\TextBlockConverter::toFieldDefinition
     */
