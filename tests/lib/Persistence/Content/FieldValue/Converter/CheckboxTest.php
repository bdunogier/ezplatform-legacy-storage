...
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\CheckboxConverter;
...
{
    /**
     * @var \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\CheckboxConverter
     */
    protected $converter;
     ...
     * @group fieldType
     * @group ezboolean
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\CheckboxConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group ezboolean
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\CheckboxConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group ezboolean
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\CheckboxConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group ezboolean
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\CheckboxConverter::toFieldDefinition
     */
