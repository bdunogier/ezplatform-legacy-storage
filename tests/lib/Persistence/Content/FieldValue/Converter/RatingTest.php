...
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\RatingConverter;
...
{
    /**
     * @var \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\RatingConverter
     */
    protected $converter;
     ...
     * @group fieldType
     * @group rating
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\RatingConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group rating
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\RatingConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group rating
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\RatingConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group rating
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\RatingConverter::toFieldDefinition
     */
