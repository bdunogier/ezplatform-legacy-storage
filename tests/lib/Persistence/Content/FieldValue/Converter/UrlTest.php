...
use EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\UrlConverter;
...
{
    /**
     * @var \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\UrlConverter
     */
    protected $converter;
     ...
     * @group fieldType
     * @group url
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\UrlConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group url
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\UrlConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group url
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\UrlConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group url
     * @covers \EzSystems\EzPlatformLegacyStorageEngine\Persistence\Content\FieldValue\Converter\UrlConverter::toFieldDefinition
     */
