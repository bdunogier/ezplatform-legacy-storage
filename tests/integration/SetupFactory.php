 ...
 */
namespace EzSystems\IntegrationTests\EzPlatformLegacyStorageEngine;
 ...
 */
class SetupFactory extends RepositorySetupFactory
{
    /**
     * Data source name.
     *
    ...
    protected function getInitialData()
    {
        if (!isset(self::$initialData)) {
            self::$initialData = include __DIR__ . '/_fixtures/clean_ezdemo_47_dump.php';
        }
    ...
    {
        $schemaPath = __DIR__ . '/../lib/Persistence/_fixtures/schema.' . self::$db . '.sql';
