 ...
 */
namespace EzSystems\EzPlatformLegacyStorageEngine\Search\Content\WordIndexer\Gateway;

use EzSystems\EzPlatformLegacyStorageEngine\Search\Content\WordIndexer\Gateway;
use EzSystems\EzPlatformLegacyStorageEngine\Database\DatabaseHandler;
use eZ\Publish\Core\Persistence\TransformationProcessor;
use EzSystems\EzPlatformLegacyStorageEngine\Search\Content\WordIndexer\Repository\SearchIndex;
...
class DoctrineDatabase extends Gateway
{
     ...
     *
     * @var \EzSystems\EzPlatformLegacyStorageEngine\Search\Content\WordIndexer\Repository\SearchIndex
     */
     ...
     * @param \EzSystems\EzPlatformLegacyStorageEngine\Search\Content\WordIndexer\Repository\SearchIndex $searchIndex
     ...
     *
     * @param \EzSystems\EzPlatformLegacyStorageEngine\Search\Content\FullTextData $fullTextData
     */
    public function index(FullTextData $fullTextData)
    {
        ...
        foreach ($fullTextData->values as $fullTextValue) {
            /** @var \EzSystems\EzPlatformLegacyStorageEngine\Search\Content\FullTextValue $fullTextValue */
